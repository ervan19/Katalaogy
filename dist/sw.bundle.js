...
function setCacheNameDetails(details) {
    if (false) {}
    cacheNames_cacheNames.updateDetails(details);
}
...
registerRoute(/.*(?:googleapis|gstatic)\.com/, new CacheFirst({
...
registerRoute(/\.(?:png|jpx|css|svg)$/, new CacheFirst({
